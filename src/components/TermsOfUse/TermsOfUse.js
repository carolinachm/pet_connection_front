...
function TermsOfUse() {
    return (
        <Container>
            ...
            <p>[Seu Nome ou Nome da Empresa] reserva-se o direito de modificar estes Termos de Uso a qualquer momento. A continuação do uso do site após quaisquer alterações constitui a aceitação dos novos termos.</p>
